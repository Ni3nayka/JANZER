...
import 'package:janzer/screens/bluetooth_maps_screen.dart';
...
class _ChatPage extends State<ChatPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
            title: (
                isConnecting ? Text('Подключение к ' + widget.server.name + '...') :
                isConnected ? Text('Live-чат с ' + widget.server.name) :
          ...
          actions: <Widget>[
            RaisedButton(
              ...
              onPressed: (){
                List list = messages.map((_message){
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => MapsBluetoothScreen(text: data, count: count,),
                    ));
              },
            )
          ],
                            ...
                            child: Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration.collapsed(
                                    hintText: (
                                          isConnecting ? 'Дождитесь подключения ...' :
                                        isConnected ? 'Напиши сообщение...' :
